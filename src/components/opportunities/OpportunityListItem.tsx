...
function UpdatedChip({ date, scNotes }: { date: string | null; scNotes: string }) {
  if (!date) {
  ...
  return (
    ...
    >
      <div className="flex justify-between items-start mb-1 gap-2">
        ...
        <UpdatedChip date={opp.lastUpdateDate} scNotes={opp.scNotes} />
      </div>
      ...
      <div className="mt-2 flex items-center gap-2 flex-wrap">
        ...
        <span className="text-[10px] text-zd-teal/40">Closes {opp.closeDate}</span>
        {isHidden && (
